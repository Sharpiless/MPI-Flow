...
parser.add_argument('--data_path', type=str, default="../kitti15/testing")
...
for i, img in enumerate(tqdm(images[159:])):
    # load input
    print(img)
    ...
    obj_masks = []
    for i in range(1):
        dst_img_path = os.path.join(opt.data_path, 'mask_2_multi', img[:-4]+'_mask_{:02d}.png'.format(i))
