...
parser.add_argument('--data_path', type=str, default="../kitti15/training/")
...
print(opt.data_path)
for i, img in enumerate(tqdm(images[2999:])):
    # load input
    print(img)
    ...
    dst_img_path = os.path.join(opt.data_path, 'mask_2_multi', img[:-4]+'_mask_03.png'.format(i))
    obj_mask = image_to_tensor(dst_img_path).cuda()  # [1,3,h,w]
