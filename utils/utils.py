...
def render_3dphoto_dynamic(
    ...
    for idx in range(1):
        ...
        writeFlow(os.path.join(data_path, '{}_{}.flo'.format(name, idx)), flow_mix)
        cv2.imwrite(os.path.join(data_path, 'image_1_{}_{}.png'.format(name, idx)), src_np)
        cv2.imwrite(os.path.join(data_path, 'image_2_{}_{}.png'.format(name, idx)), inpainted)
